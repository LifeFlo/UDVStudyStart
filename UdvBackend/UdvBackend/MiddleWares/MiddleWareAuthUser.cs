...
public class MiddleWareCheckToken
{
    ...
    public MiddleWareCheckToken(RequestDelegate next, ILog log, IAccountRepository accounts, ITokenRepository tokens, IRoleRepository roleRepository)
    {
        _next = next;
        _log = log;
        _accounts = accounts;
